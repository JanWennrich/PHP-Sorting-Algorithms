...
abstract class AbstractSortingAlgorithmTest extends TestCase
{
    ...
    public function testSortWithDatasetContainingOneElement(): void
    {
        self::assertEquals(
            [1],
    ...
    public function testSortWithDatasetContainingTwoElementsInReverse(): void
    {
        self::assertEquals(
            [1,2],
            $this->sortingAlgorithm->sort([2,1])
        );
    }
}
